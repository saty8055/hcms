...
export class ApiService {
  ...
  private HOST: string = "http://localhost:8063";
  ...
  private EMPLOYEE_URL = this.SECURE + "/employee";
  private SERVICE_URL = this.SECURE + "/services";
  private TASK_URL = this.SECURE + "/task";
